...
class Wdate extends Component{
  ...
  textValue = () => {
    ...
    let str = 'import { Wdate } from react-native-wui\r\rimport { View } from "react-native"\r\rclass Modal extends Component{\r\xa0\xa0\xa0\xa0render(){\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0return(\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0<View style={{flex:1}}>\n\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0<Wdate />\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0</View>\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0)\r\xa0\xa0\xa0\xa0}\r\xa0\xa0}\r\rexport default Modal'
    container.value = str
  }
    ...
    return(
      <div
        ...
        <div
          ...
          <h1 style={{fontSize:'30px',color:'#1890FF',letterSpacing:1}}>Wdate</h1>
          ...
          <ol>
            {
              [
                ...
                {
                  title:'noChoiceDateStyle (object)',
                  explain:'没有选中日期的文本样式设置'
                },
                {
                  title:'choiceDateStyle (object)',
                  explain:'选中日期的文本样式设置'
                },
                {
                  title:'topMonthStyle (object)',
                  explain:'顶部显示文本样式设置'
                },
                {
                  title:'bottomWeekStyle (object)',
                  explain:'底部显示的文本样式设置'
                },
                {
