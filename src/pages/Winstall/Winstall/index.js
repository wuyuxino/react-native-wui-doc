    ...
    return (
      ...
      >
        ...
        <div>
          ...
          >
            # npm install react-native-image-picker / yarn add react-native-image-picker
            <br />
            <br />
            # react-native link react-native-image-picker
            <br />
            <br />
            # ios相机相册权限添加代码,将以下代码添加到info.plist中
            <br />
            <br />
            &lt;key&gt;NSCameraUsageDescription&lt;/key&gt; <br />
            &lt;string&gt;$(PRODUCT_NAME) would like to use your camera（Used for uploading user
            avatars）&lt;/string&gt; <br />
            ...
            &lt;string&gt;$(PRODUCT_NAME) would like to save photos to your photo gallery （Used for
            save user avatars）&lt;/string&gt; <br />
            &lt;key&gt;NSPhotoLibraryUsageDescription&lt;/key&gt; <br />
            &lt;string&gt;$(PRODUCT_NAME) would like access to your photo gallery （Used for
            uploading user avatars）&lt;/string&gt; <br />
            <br />
            # 页面内部使用代码
            <br />
            <br />
            import ImagePicker from 'react-native-image-picker' <br />
            <br />
            selectPhoto = () => &#123; <br />
            &nbsp;&nbsp;const options = &#123; <br />
        ...
        <div>
          ...
          >
            react-native-linear-gradient 的安装
          </p>
          <div
            style={{
              fontSize: '13px',
          ...
          >
            # npm install --save react-native-linear-gradient <br />
            <br />
            # react-native link react-native-linear-gradient <br />
            <br />
            # 页面中的使用 <br />
            <br />
            ...
            &lt;LinearGradient
            <br />
            &nbsp;&nbsp;start=&#123;&#123; x : 0.0, y : 1 &#125;&#125; end=&#123;&#123; x : 0, y : 0
            &#125;&#125;
            <br />
            &nbsp;&nbsp;locations=&#123;[ 0, 0.2, 1 ]&#125;
            <br />
            &nbsp;&nbsp;colors=&#123;[ '#333', '#666', 'rgba(0,0,0,0)' ]&#125;
            <br />
            &nbsp;&nbsp;style=&#123;&#123;
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;position:'absolute',
        ...
        <div>
          ...
          >
            # npm install --save react-native-gifted-chat <br />
            <br />
            # 在页面中的使用 <br />
            <br />
            import &#123; GiftedChat, Bubble &#125; from 'react-native-gifted-chat' <br />
            <br />
            this.state = &#123; <br />
            ...
            &nbsp;&nbsp;user=&#123;&#123; <br />
            &nbsp;&nbsp;&nbsp;&nbsp;_id: 1, <br />
            &nbsp;&nbsp;&nbsp;&nbsp;avatar:'http://life.southmoney.com/tuwen/UploadFiles_6871/201808/20180808151217516.jpg',{' '}
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;name:'pater' <br />
            &nbsp;&nbsp;&#125;&#125; <br />
            /&gt; <br />
        ...
        <div>
          ...
          >
            ...
            <br />
            <br />
            # 以前需要link的组件，这里不需要link了，否则会报错
            <br />
            <br />
            # 切换到新建项目的根目录下面的ios文件夹下面，然后执行 pod install
            <br />
            <br />
            # 执行完毕会自动link需要link的组件
            <br />
            <br /># react-native run-ios --simulator '手机型号' （即可运行项目）
          </div>
        </div>
      </div>
    );
