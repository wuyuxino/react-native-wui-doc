...
import wcode from '../../../assets/wcode.png'
...
class Wcode extends Component{
  ...
  textValue = () => {
    ...
    let str = 'import { Wcode } from react-native-wui\r\rimport { View } from "react-native"\r\rclass Modal extends Component{\r\xa0\xa0\xa0\xa0render(){\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0return(\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0<View style={{flex:1}}>\n\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0<Wcode />\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0</View>\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0)\r\xa0\xa0\xa0\xa0}\r\xa0\xa0}\r\rexport default Modal'
    container.value = str
  }
    ...
    return(
      <div
          ...
          <ol>
            {
              [
                ...
                {
                  title:'tipText (number、string)',
                  explain:'提示文字设置'
                },
                {
                  title:'unitText (string)',
                  explain:'时间单位（s）'
                },
                {
                  title:'srcondNum (number)',
        ...
        <div
          ...
          <h1 style={{fontSize:'30px',color:'#1890FF',letterSpacing:1}}>Wcode</h1>
