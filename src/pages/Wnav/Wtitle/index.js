...
import wtitle from '../../../assets/wtitle.png'
...
class WheaderPage extends Component{
  ...
  textValue = () => {
    ...
    let str = 'import { Wtitle } from react-native-wui\r\rimport { View } from "react-native"\r\rclass Modal extends Component{\r\xa0\xa0\xa0\xa0render(){\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0return(\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0<View style={{flex:1}}>\n\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0<Wtitle />\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0</View>\r\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0)\r\xa0\xa0\xa0\xa0}\r\xa0\xa0}\r\rexport default Modal'
    container.value = str
  }
    ...
    return(
      <div
          ...
          <ol>
            {
              [
                ...
                {
                  title:'titleContent (string、number)',
                  explain:'标题文字显示设置'
                },
                {
                ...
                {
                  title:'rightTextContent (string、number)',
                  explain:'右侧显示文字设置'
                },
                {
        ...
        <div
          ...
          <h1 style={{fontSize:'30px',color:'#1890FF',letterSpacing:1}}>Wtitle</h1>
